...
?>
<link rel="stylesheet" type="text/css" href="./css/template_six.css">
...
<?php
	...
	if ($_SERVER['REQUEST_METHOD'] === 'POST') {
		if (isset($_POST['createPDF'])) {
				header("Location: ./pdf.php?id_curriculum=$id_curriculum&template=6");
			}else if(isset($_POST['sendEmail'])){
				header("Location: ./enviar_correo.php?id_curriculum=$id_curriculum&template=6");
			...
			<div class="all_template">
				<div class="almacen_teamplate">
					<div id="doc2" class="yui-t7">
						...
						<div id="btn_pdf">
							<form method="post">
									<button id="pdf" class="btn btn-dark" name="createPDF">Download PDF</button>
									<button id="pdf" class="btn btn-dark" name="sendEmail">SEND EMAIL</button>
							</form>
						</div>
						<div id="hd">
							<div class="yui-gc">
							...
							<div id="yui-main">
								<div class="yui-b">
									<div class="yui-gf">
										...
										<div class="yui-u">
											<p class="enlarge"><?php echo $info_personal[0]['about_you'] ?>
