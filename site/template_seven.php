...
?>
<link rel="stylesheet" type="text/css" href="./css/template_seven.css">
...
<?php
	...
	if ($_SERVER['REQUEST_METHOD'] === 'POST') {
		if (isset($_POST['createPDF'])) {
				header("Location: ./pdf.php?id_curriculum=$id_curriculum&template=7");
			}else if(isset($_POST['sendEmail'])){
				header("Location: ./enviar_correo.php?id_curriculum=$id_curriculum&template=7");
			}else if(isset($_POST['next_temp'])){
                 header("Location: ./template_eight.php?id_curriculum=$id_curriculum");
            }else{
			...
			<div class="all_template">
				<div class="almacen_teamplate">
					<div id="doc2" class="yui-t7">
						...
						<div id="btn_pdf">
							<form method="post">
									<button id="pdf" class="btn btn-danger" name="createPDF">Download PDF</button>
									<button id="pdf" class="btn btn-danger" name="sendEmail">SEND EMAIL</button>
							</form>
						</div>
						<div id="hd">
							<div class="yui-gc">
															...
															<?php foreach ($info_skills as $skill) {?>
																<div class="job">
																	<h2>Name: <?php echo $skill['name'] ?></h2>
																	 <div class="progress">
												                        <div class="progress-bar progress-bar-primary aos-init aos-animate" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $skill['level'] ?>%; background-color: green;">
